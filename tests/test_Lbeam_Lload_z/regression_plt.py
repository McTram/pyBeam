...
plt.plot(beam.coordinate_X, beam.coordinate_Y, beam.coordinate_Z)
plt.plot(beam.coordinate_X0, beam.coordinate_Y0, beam.coordinate_Z0)
plt.xlabel('X')
plt.ylabel('Y')
plt.show()
